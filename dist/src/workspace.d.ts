import type { LlmQueryRole, RlmArtifactSummary, RlmChildArtifact, RlmConsolidationRef, RlmRetentionMetrics, RlmRetentionPolicy, RlmValueManifest, RlmWorkspace, RlmWorkspaceManifest } from "./types.js";
...
export declare function recordArtifact(workspaceValue: unknown, artifactValue: RlmChildArtifact, maxArtifacts?: number): RlmWorkspace;
export declare function buildValueManifest(value: unknown, path: string, options?: {
...
export declare function buildWorkspaceManifest(workspaceValue: unknown, options?: {
    sectionKeys?: string[];
...
export declare function recordRetentionLease(workspaceValue: unknown, input: {
...
export declare function recordRetentionMetrics(workspaceValue: unknown, latestMetrics: RlmRetentionMetrics, latestTurnIndex: number, policy?: Pick<RlmRetentionPolicy, "expireConsolidatedAfterTurns" | "keepLatestSurfaceSummary">): RlmWorkspace | undefined;
export declare function buildWorkspacePointerHints(workspaceValue: unknown): string | undefined;
export declare function selectRelevantArtifacts(workspaceValue: unknown, options?: {
    prompt: string;
    role: LlmQueryRole;
    limit?: number;
}): RlmArtifactSummary[];
export declare function selectRelevantWorkspaceSectionKeys(role: LlmQueryRole, workspaceValue: unknown): string[];
export declare function attachInternalLlmQueryContext<T>(input: T, context: {
