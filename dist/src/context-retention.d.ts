...
export declare function buildRetentionCompactionSummary(workspace: RlmWorkspace | null | undefined, preparation: {
...
export declare function applyRetentionPolicy(messages: AgentMessage[], options?: {
